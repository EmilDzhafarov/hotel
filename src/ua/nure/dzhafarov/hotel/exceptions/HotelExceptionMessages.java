...
public final class HotelExceptionMessages {
    private HotelExceptionMessages() {}

    public static final String ERR_CANNOT_OBTAIN_CONNECTION = "Cannot obtain a connection from the pool";

    public static final String ERR_CANNOT_OBTAIN_ALL_NOT_PAID_ORDERS = "Cannot obtain all not paid orders";

    public static final String ERR_CANNOT_OBTAIN_HOTEL_ROOMS_BY_STATUS = "Cannot obtain hotel rooms by their status";

    public static final String ERR_CANNOT_OBTAIN_HOTEL_ROOMS_BY_APARTMENT_CLASS = "Cannot obtain hotel rooms by their apartment class";

    public static final String ERR_CANNOT_OBTAIN_BILLS_BY_PAY = "Cannot obtain bills by their value isPaid";
